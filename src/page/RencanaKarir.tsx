  ...
  return (
    <div className="relative bg-secondary">
      <div className="container mx-auto max-w-6xl px-4 md:px-8 py-12 min-h-[85dvh]">
        ...
        <div
          className="mt-8 grid w-full items-center gap-3 print:hidden max-w-sm"
          id="nama"
        >
        ...
        <div className="flex items-center gap-2 ">
          <Button
            className="flex gap-2 print:hidden w-auto mt-12 bg-gray-700 text-white hover:bg-gray-700/90"
            onClick={previewCareer}
          >
            <Eye />
            Lihat Sertifikat
          </Button>
